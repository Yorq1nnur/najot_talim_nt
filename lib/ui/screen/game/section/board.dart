...
class _BoardWidgetState extends State<BoardWidget>
  ...
  static const _animColorBackgroundTag = "color_background";
  ...
  static const int _animDurationMover = 350;
  static const int _animDurationColorsBackground = 200;
  ...
  void _startAppearAnimation(Chip chip) {
    final duration = Duration(
        milliseconds: _applyAnimationMultiplier(_animDurationBlinkHalf));
  ...
  void _startColorBackgroundAnimation(Chip chip,
    ...
    final duration = Duration(
        milliseconds:
            _applyAnimationMultiplier(_animDurationColorsBackground));
    const curve = Curves.easeIn;
    ...
    _addAnimation(chip, _animColorBackgroundTag, controller);
    controller
        .forward()
        .then<void>((_) => _disposeAnimation(chip, _animColorBackgroundTag));
  }
  ...
  void _startMoveAnimation(Chip chip, Point<int> point) {
    final controller = AnimationController(
      duration: Duration(
          milliseconds: _applyAnimationMultiplier(_animDurationMover)),
      vsync: this,
    );
