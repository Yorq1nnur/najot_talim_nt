...
import 'package:najot_talim_nt/data/board.dart';
import 'package:najot_talim_nt/data/chip.dart';
...
class _GameLogicImpl implements GameLogic {
  ...
  Board hardest(Board board) {
    ...
    switch (board.size) {
      case 3:
        variants = startingPositions_3X3;
        break;
      case 4:
        variants = startingPositions_4X4;
        break;
      case 5:
        variants = startingPositions_5X5;
        break;
      default:
